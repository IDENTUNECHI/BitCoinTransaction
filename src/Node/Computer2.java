...
public class Computer2 {
    ...
    public Computer2(String transactionData) {
        this.transactionData = transactionData;
        System.out.println("Computer2: 거래 데이터를 수신했습니다.");
    }

    public boolean verifyTransaction(String publicKey, String signature) {
        System.out.println("Computer2: 거래를 검증 중...");
        boolean isValid = !transactionData.isEmpty() && signature != null && publicKey != null;
        if (isValid) {
            System.out.println("Computer2: 거래가 유효합니다.");
        } else {
            System.out.println("Computer2: 거래가 유효하지 않습니다.");
        }
        return isValid;
    }

    public String mineBlock(String previousHash) {
        System.out.println("Computer2: 블록 채굴을 시작합니다...");
        String hash;
        int nonce = 0;
        ...
        try {
            ...
            System.out.println("Computer2: 블록 채굴 완료! 해시값: " + hash);
            return hash;
